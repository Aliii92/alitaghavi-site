...
export default function NeginAreaPageError({ error }) {
  console.error("[app/negin/areas/[area]/error]", error);
      ...
      <div className="content-shell listings-page-shell">
        <section className="section listings-intro-section">
          <div className="section-header centered listings-page-header">
            ...
            <Link className="button secondary-button back-to-listings-button" href="/negin/ready-properties">
              Back to All Areas
            </Link>
          </div>
        </section>
