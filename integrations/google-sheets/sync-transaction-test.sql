...
begin
  ...
  select count(*) into n from public.properties where id='dl-ffffffff-ffff-4fff-8fff-ffffffffffff' and price='2100000' and deal->>'type'='urgent' and notes='PRIVATE' and featured and floor_plan_url='https://example.com/plan.pdf' and jsonb_array_length(gallery_images)=1;
  ...
  select count(*) into n from public.resale_off_plan where id='dl-ffffffff-ffff-4fff-8fff-ffffffffffff' and price='2100000' and deal->>'type'='urgent' and notes='PRIVATE' and featured and floor_plan_url='https://example.com/plan.pdf';
